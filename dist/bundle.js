...
/* harmony import */ var _scripts_LiveStream__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../scripts/LiveStream */ "./src/scripts/LiveStream.js");
...
var App = function App() {
  ...
  new _scripts_LiveStream__WEBPACK_IMPORTED_MODULE_8__["default"]();
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LiveStream; });
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js");
/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__);
...
var LiveStream = function LiveStream() {
  ...
  fetch("https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UClFOMH3zrHqx9Sab5e95o-g&key=AIzaSyACup5liIWZnnWqjnzwBiIodBdRMCJIwxc").then(function (data) {
    return data.json();
  }).then(function (data) {
    if (data.items.snippet.liveBroadcastContent === "live") {
      document.querySelector(".swiper-container").innerHTML = "";
      var iframe = document.createElement("iframe");
      iframe.src = "https://www.youtube.com/embed/live_stream?channel=UClFOMH3zrHqx9Sab5e95o-g";
